...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-gradient-to-b from-gray-900 to-gray-950 border-t border-violet-500/20 pt-16 pb-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="md:col-span-5 space-y-6">
              <div className="flex items-center gap-3">
                <div className="bg-gradient-to-r from-red-500 to-violet-600 p-2 rounded-xl">
              ...
              <div className="flex gap-4 pt-4">
                <a 
                  href="#" 
                  className="bg-gray-800 hover:bg-gradient-to-r from-red-500 to-violet-600 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-violet-500/30 group"
                  aria-label="Twitter"
                >
            ...
            <div className="md:col-span-2">
              <h3 className="text-violet-400 font-semibold mb-6 text-lg flex items-center gap-2">
              ...
              <ul className="space-y-3">
                {['Models', 'Pricing', 'Features', 'API', 'Documentation'].map((item) => (
                  <li key={item}>
                    <a 
                      href="#" 
                      className="text-gray-400 hover:text-violet-400 transition-all duration-300 hover:translate-x-1 inline-block"
                    >
                      {item}
                    </a>
                  </li>
            ...
            <div className="md:col-span-3">
              <h3 className="text-violet-400 font-semibold mb-6 text-lg">Legal</h3>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-2">
                  <input 
                    ...
                    className="bg-gray-800 text-white text-sm px-4 py-2 rounded-lg flex-grow focus:outline-none focus:ring-2 focus:ring-violet-500"
                  />
                  <button className="bg-gradient-to-r from-red-500 to-violet-600 hover:from-red-600 hover:to-violet-700 text-white px-4 py-2 rounded-lg transition-all duration-300 text-sm font-semibold whitespace-nowrap">
                    Subscribe
                  </button>
                </div>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-gradient-to-r from-red-500 to-violet-600 hover:from-red-600 hover:to-violet-700 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 z-50 group"
